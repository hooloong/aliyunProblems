...
if __name__ == '__main__':
	user_table = pd.read_csv('../../../../data/fresh_comp_offline/tianchi_fresh_comp_train_user.csv')
	item_table = pd.read_csv('../../../../data/fresh_comp_offline/tianchi_fresh_comp_train_item.csv')
	...
	user_table.to_csv('../../../../data/fresh_comp_offline/drop1112_sub_item.csv',index=None)
