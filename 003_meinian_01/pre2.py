...
# 读取数据
part_1 = pd.read_csv('../../data/aliyun_meinian/meinian_round1_data_part1_20180408.csv',sep='$')
part_2 = pd.read_csv('../../data/aliyun_meinian/meinian_round1_data_part2_20180408.csv',sep='$')
